...
export const sections: Section[] = [
  ...
  { id: 'sql-theory', name: 'SQL Theory', description: 'Joins, Constraints, Window Functions', icon: 'dbms' },
  { id: 'sql-queries', name: 'SQL Practical Queries', description: 'Hands-on queries, grouping, duplicates', icon: 'dbms' },
